        ...
        if (isset($_POST['add'])) {
          ...
          if (file_exists("upload/" .$_FILES["service_image"]["name"])) {
            ...
            echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                    <strong>Error!</strong> Image is already exists.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                      <span aria-hidden="true">&times;</span>
                    </button>
                  </div>';
          } else {
            $query ="INSERT INTO service(service_name, service_type, description, price, service_image, status) 
            VALUES('$name','$cat','$desc', $price, '$images',1)";
            ...
            if ($query_run) {
              ...
              echo '<div class="alert alert-danger alert-dismissible fade show" role="alert">
                      <strong>Error!</strong> Check you inputs, Service was not added Successfully.
                      <button type="button" class="close" data-dismiss="alert" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>';
      ...
      <form action="" method="POST" enctype="multipart/form-data">
        <div class="form-row">
          ...
          <div class="col-md-4 mb-4">
            ...
            <select type="text" class="form-control" id="validationDefault01" placeholder="Type" name="service_cat" required>
              <option></option>
          ...
          <div class="col-md-4 mb-4">
            ...
            <input type="file" class="form-control" id="validationDefault01" placeholder="Image" name="service_image" required>
          </div>
